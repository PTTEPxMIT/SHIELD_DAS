...
gauge_1 = WGM701_Gauge(
    ...
    export_filename="results/WGM701_pressure_data.csv",
)
gauge_2 = CVM211_Gauge(
    test_mode=True,
    gauge_location="upstream",
    export_filename="results/CVM211_pressure_data.csv",
)
gauge_3 = Baratron626D_Gauge(
    name="Baratron626D_1000T",
    test_mode=True,
    gauge_location="upstream",
    export_filename="results/Baratron626D_1000T_pressure_data.csv",
)
gauge_4 = Baratron626D_Gauge(
    name="Baratron626D_0.1T",
    test_mode=True,
    gauge_location="downstream",
    export_filename="results/Baratron626D_0.1T_pressure_data.csv",
)
